...
public class MyJobAdapter extends BaseAdapter {
    ...
    public MyJobAdapter(Context context, MyJobAdapter.OnItemClickListener onItemClickListener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (viewType) {
            case TYPE_ITEM:
                ...
                if (v == null) {
                    v = mInflater.inflate(R.layout.fragment_job_info_list_item, parent, false);
    ...
    private static class ItemViewHolder implements View.OnClickListener {
        ...
        ItemViewHolder(@NonNull View view, final MyJobAdapter.OnItemClickListener listener) {
